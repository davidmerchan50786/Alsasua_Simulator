...
//  de Assets/Textures/Roads/ y los asigna al GeneradorMeshCalles.
//
...
public static class CreadorMaterialAsfalto
{
    ...
    [MenuItem("Alsasua GTA/Crear Materiales de Asfalto", false, 10)]
    public static void CrearMateriales()
    {
        ...
        // ── Asignar al GeneradorMeshCalles si está en escena ──────────────
        var generador = Object.FindFirstObjectByType<GeneradorMeshCalles>();
        if (generador != null)
        {
            ...
            Debug.Log("[AsfaltoSetup] Materiales asignados al GeneradorMeshCalles.");
        }
        else
        {
            Debug.LogWarning("[AsfaltoSetup] GeneradorMeshCalles no encontrado en la escena. " +
        ...
        EditorUtility.DisplayDialog("Materiales de Asfalto",
            ...
            (generador != null ? "✅ Asignados al GeneradorMeshCalles." :
             "⚠ Añade GeneradorMeshCalles a la escena y ejecuta de nuevo."),
            "OK");
    }
