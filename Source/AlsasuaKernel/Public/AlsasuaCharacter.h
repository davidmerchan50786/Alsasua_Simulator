...
UCLASS(config=Game)
class ALSASUAKERNEL_API AAlsasuaCharacter : public ACharacter, public IAbilitySystemInterface, public IDamageable
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Disfraz", meta = (AllowPrivateAccess = "true"))
	TObjectPtr<class UDisguiseComponent> DisguiseComponent;
	void InitializeGAS();
