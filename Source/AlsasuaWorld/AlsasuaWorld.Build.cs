...
public class AlsasuaWorld : ModuleRules
{
    public AlsasuaWorld(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "AlsasuaCore", "AlsasuaKernel", "AlsasuaContracts", "ProceduralMeshComponent", "NavigationSystem", "Json", "JsonUtilities" });
