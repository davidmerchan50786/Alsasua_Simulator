...
public:
	...
	/** 1 = encubierto, 0 = a cara descubierta. Es UDisguiseComponent::IsDisguised(). */
	 ...
	 * escrito; UGuardadoSubsystem le ponía un 1.0f fijo y nadie lo leía. El
	 * estado real vive en UDisguiseComponent y es de sesión, no de partida. Si algún día hay durabilidad, éste es su hueco.
	 */
