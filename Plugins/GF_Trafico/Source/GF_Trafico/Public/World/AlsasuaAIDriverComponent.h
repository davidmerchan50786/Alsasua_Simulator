...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Alsasua|Traffic")
	void SetRouteFromGraph(UAlsasuaStreetGraph* Graph, int32 StartNode, int32 EndNode);
...
private:
	/** Grafo en uso; se resuelve del subsistema de tráfico si nadie lo inyectó. */
	UPROPERTY() TObjectPtr<UAlsasuaStreetGraph> Grafo = nullptr;
	...
	UAlsasuaStreetGraph* ResolverGrafo();
